            ...
            <div className="AdminDashboard-card" key={card.title}>
              ...
              <p style={{ color: card.color }}>
                <img
                  src={card.nameIcon}
                  alt=""
                  className="AdminDashboard-cardNameIcon"
                />
                {card.sub}
              </p>
            </div>
                ...
                <div className="AdminDashboard-chartCard">
                  <div className="AdminDashboard-chartHeader">
                    ...
                    <p className="AdminDashboard-legend">
                      <span className="AdminDashboard-legendDot"></span>
                      Placements
                    </p>
                  </div>
                  ...
                  <div className="AdminDashboard-bars">
                    {months.map((item) => (
                      <div className="AdminDashboard-barBox" key={item.month}>
                        <div
                          className={`AdminDashboard-bar ${
                            item.active ? "AdminDashboard-barActive" : ""
                          }`}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="AdminDashboard-activityMeta">
                          ...
                          <span className="AdminDashboard-activityMetaDot"></span>
                  ...
                  <tbody>
                    {users.map((user) => (
                      <tr key={user.email}>
                        ...
                        <td>
                          <span className="AdminDashboard-badge">
                            {user.role}
                          </span>
                        </td>
                        ...
                        <td>
                          <img
                            src={admin_more}
                            alt="more"
                            className="AdminDashboard-rowActionIcon"
                          />
                        </td>
                      </tr>
                    ))}
